...
@interface OAAnalyticsErsion : NSObject<NSSecureCoding,NSCoding>
...
+ (OAAnalyticsErsion *)chapingActionc;
+ (void)setSDKConfig:(OAAnalyticsErsion *)config;
+ (void)bindingAccountActionr;
@end
